...
export { PointerLockControls } from '../examples/js/controls/PointerLockControls.js';
export { DeviceOrientationControls } from '../examples/js/controls/DeviceOrientationControls.js';
export { CopyShader } from '../examples/js/shaders/CopyShader.js';
export { FXAAShader } from '../examples/js/shaders/FXAAShader.js';
export { EffectComposer } from '../examples/js/postprocessing/EffectComposer.js';
export { ShaderPass } from '../examples/js/postprocessing/ShaderPass.js';
export { OutlinePass } from '../examples/js/postprocessing/OutlinePass.js';
export { RenderPass } from '../examples/js/postprocessing/RenderPass.js';